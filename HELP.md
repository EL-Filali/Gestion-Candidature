...
* The original package name 'ma.Gestion-Candidature.gestion candidature' is invalid and this project uses 'ma.GestionCandidature.gestion.candidature' instead.
